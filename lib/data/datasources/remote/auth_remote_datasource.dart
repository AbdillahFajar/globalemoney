...
abstract class AuthRemoteDatasource {
  ...
  void setAuthToken(String token); //Menambahkan setAuthToken ke interface agar AuthRepositoryImpl bisa memanggil setAuthToken via _remote (tanpa coupling langsung ke ApiClient).
  void clearAuthToken();
}
