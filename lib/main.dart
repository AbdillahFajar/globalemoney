...
void main() async {
  ...
  // Initialize (menyiapkan) dependency injection (di)
  await di.init();
  ...
  await _deeplinkService.init(); //DeeplinkService.init() dipanggil setelah DI siap. Menerima AppRouter.router (singleton) agar navigasi deeplink menggunakan navigator yang sama dengan MaterialApp.
