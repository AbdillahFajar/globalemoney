...
enum _Step { pin, otp } //step yang sedang ditampilkan
...
class _PinPageState extends State<PinPage> {
  ...
  String _twoFaMethod = AppConstants.twoFaTotp; //dibaca dari SecureStorage
  ...
  // Aplikasi membaca metode 2FA yang dikonfigurasi user, lalu kirim OTP (smtp/notif) atau
  ...
  // Step 2: kode OTP/TOTP lengkap (6 digit) → kirim ke endpoint transfer/pembayaran.
